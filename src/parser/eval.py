...
### MAIN : /home/ai/github/magicc/languages/bnf ###
...
def p_main_program(expr, module: str = g_main):
    global g_modules 
    ...
    for path in g_paths:
        ...
        prefix = os.path.dirname(get_config("input")[0]) if path == g_main else f".lib/{path}"
...
"""
    ...
    with open("../new/compiler/parserdata.py", "w") as file:
        file.write(AST)
    # with open("../new/compiler/evaluation.py", "w") as file:
...
def p_main_require(expr):
    ...
    path = expr(0).removeprefix("#require").strip().lower().split(".")
